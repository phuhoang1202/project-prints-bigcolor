...
import RelatedArticles from "./contnetArticles/RelatedArticles";
import PopularArticles from "./contnetArticles/PopularArticles";
import Header from "../header/Header";
import Navbar from "../navbar/Navbar";
import Footer from "../footer/Footer";
import Copyright from "../copyright/Copyright";
import Img1 from "@assets/users/images/blog/blog-details-01.jpg";
import Img2 from "@assets/users/images/blog/author-01.png";
import BannerSection from "./contnetArticles/BannerSection";
      ...
      <section className="pb-10 pt-10 dark:bg-dark lg:pb-20">
        ...
        "
                  ...
                  <div className="flex flex-wrap items-center p-4 pb-4 sm:px-8">
                    <div className="flex items-center mb-4 mr-5 md:mr-10">
                      ...
                      <p className="text-base font-medium text-white">
                        ...
                        <a
                          href="#"
                          className="text-white hover:opacity-70 ml-1"
                        >
                          BigColor Việt Nam
                        </a>
                      </p>
              ...
              "
                    ...
                    <p
                      className="mb-8 text-base wow fadeInUp text-body-color dark:text-dark-6"
                      data-wow-delay=".1s"
                    >
                      There's a time and place for everything… including asking
                      for reviews. For instance: you should not asking for a
                    ...
                    <h3
                      className="wow fadeInUp mb-6 text-2xl font-bold text-dark dark:text-white sm:text-[28px] sm:leading-[40px]"
                      data-wow-delay=".1s"
                    >
          ...
          <div className="flex flex-wrap -mx-4">
            <div
              className="w-full px-4 wow fadeInUp mt-14"
              data-wow-delay=".2s"
            >
